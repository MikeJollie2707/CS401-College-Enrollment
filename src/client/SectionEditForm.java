...
public class SectionEditForm {
    ...
    public SectionEditForm(Section section) {
        ...
        JTextField sectionCapacity = new JTextField(String.valueOf(section.getMaxCapacity()));
        JTextField sectionWaitlist = new JTextField(String.valueOf(section.getMaxWaitlistSize()));
        JTextField sectionInstructor = new JTextField(section.getInstructor().getName());
    ...
    public Section getEditedSection() {
        ...
        String rawCapacity = results.get(0);
        String rawWaitlist = results.get(1);
        String rawInstructor = results.get(2);
        String rawSchedule = results.get(3);
